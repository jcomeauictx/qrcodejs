...
(function () {
	...
	function QR8bitByte(data) {
		...
		if (QRCode.binaryMode) {
			// binary mode: pass raw byte values, no UTF-8 encoding or BOM
			for (var i = 0, l = this.data.length; i < l; i++) {
				this.parsedData.push(this.data.charCodeAt(i) & 0xFF);
			}
		} else {
	...
	function _getTypeNumber(sText, nCorrectLevel) {
		var nType = 1;
		var length = QRCode.binaryMode ? sText.length : _getUTF8Length(sText);
